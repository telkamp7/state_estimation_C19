...
As observed in Figure \@ref(fig:admissionsReg) and later confirmed in Figure \@ref(fig:admittedRegPred) there is a clear correlation in the number of new hospital admissions between the regions. Intuitively, this makes sense as infected individuals can move freely between the regions, and spread the disease. Hence, a possible extension to the model could be to include a correlation between the regions.
